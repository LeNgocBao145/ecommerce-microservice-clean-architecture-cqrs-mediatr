        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Order_DiscountAmount_NonNegative", "[DiscountAmount] >= 0");
                    table.CheckConstraint("CK_Order_Status", "[Status] IN ('Pending', 'Processing', 'Shipped', 'Delivered','Cancelled', 'Refunded')");
